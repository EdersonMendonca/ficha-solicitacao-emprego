...
class JobApplicationForm extends Component {
    constructor(props) {
        super(props);
        this.state = {
            funcao_pretendida: 'Desenvolvedor Web',
            nome: 'João da Silva',
            ctps: '123456',
            serie: 'AB1234',
            ...
            numero: '123',
            bairro: 'Centro',
            municipio: 'Exemploville',
            uf: 'EX',
            cep: '12345-678',
            naturalidade: 'Exemploville',
            telefone: '(12) 3456-7890',
            celular: '(98) 7654-3210',
            email: 'joao@example.com',
            fundamental: 'completo',
            medio: 'completo',
            superior: 'incompleto',
            cursoSuperior: 'Ciência da Computação',
            tituloEleitor: '987654321',
            zona: '123',
            pis: '12345678900',
            carteiraHabilitacao: '123456789',
            nomePai: 'José da Silva',
            nomeMae: 'Maria da Silva',
            estadoCivil: 'solteiro',
            nomeConjuge: '',
            residencia: 'propria',
            certidaoMilitar: '123456789',
            serieCertidao: 'A',
            categoriaCertidao: 'Reservista',
            possuiFilhos: 'nao'
        };
    ...
    render() {
        return (
            <div className="container p-3 mt-3 mb-5">

                <div className="row justify-content-center">
                    <form onSubmit={this.handleSubmit} className='w-50 bg-light p-3'>
